...
export const characterCardExampleTemplate: VisualTemplateDefinition = {
  ...
  elements: [
    ...
    },
    {
      id: "level",
      type: "text",
      value: "LEVEL {{result.fields.level}}",
      x: 80,
      y: 370,
      width: 420,
      fontSize: 28,
...
export const personalityResultExampleTemplate: VisualTemplateDefinition = {
  ...
  elements: [
    ...
    },
    {
      id: "personality",
      type: "text",
      value: "{{result.fields.personality}}",
      x: 120,
      y: 535,
      width: 840,
      fontSize: 68,
...
export const customResultPosterExampleTemplate: VisualTemplateDefinition = {
  ...
  elements: [
    ...
    },
    {
      id: "relationship",
      type: "text",
      value: "{{result.fields.relationship}}",
      x: 65,
      y: 225,
      width: 650,
      fontSize: 32,
    ...
    },
    {
      id: "special-label",
      type: "badge",
      value: "{{result.fields.special_label}}",
      x: 65,
      y: 285,
      width: 650,
      fontSize: 28,
    ...
    },
    {
      id: "special-trait",
      type: "text",
      value: "{{result.fields.special_trait}}",
      x: 65,
      y: 340,
      width: 650,
      fontSize: 30,
  ...
  sections: [
    {
      id: "basic",
      type: "table",
      title: "01. 基础概况 / BASIC PROFILE",
      source: "{{result.metadata.profile}}",
      columns: 2,
      label: "{{label}}",
      value: "{{value}}",
      color: "#431407",
    ...
    },
    {
      id: "gallery",
      type: "gallery",
      title: "02. 视觉记录 / PHOTO GALLERY",
      source: "{{result.metadata.gallery}}",
      columns: 2,
      gap: 20,
      imageHeight: 260,
      radius: 20,
    ...
    },
    {
      id: "status",
      type: "status_grid",
      title: "03. 状态检查 / STATUS CHECK",
      source: "{{result.metadata.status}}",
      columns: 3,
      label: "{{name}}",
      itemHeight: 64,
      color: "#431407",
    ...
    },
    {
      id: "metrics",
      type: "metrics",
      title: "04. 量化指标 / QUANTITATIVE METRICS",
      source: "{{result.stats}}",
      columns: 2,
      label: "{{label}}",
      itemHeight: 88,
    ...
    },
    {
      ...
      type: "summary",
      title: "05. 总结 / SUMMARY",
      source: "{{result.metadata.summary}}",
      fontSize: 30,
      color: "#431407",
      fill: "#fdba74",
    },

...
export interface DraftQuestion {
  type: QuestionType;
  title: string;
  /** Undefined only for drafts written before the required-toggle was added. */
  required?: boolean;
  options: DraftOption[];
    ...
    return {
      ...
      questions: [
        ...state.questions,
        {
          ...
          required: state.currentQuestionRequired,
          options: state.currentOptions,
          matrixColumns: state.currentMatrixColumns ?? [],
